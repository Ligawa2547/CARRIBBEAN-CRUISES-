...
const featuredJobs = [
  {
    ...
    location: "Northern Europe Routes",
    salary: "$3,000 - $3,800 monthly",
    description: "Deliver exceptional service to our guests, assist with inquiries, and ensure a seamless onboard experience throughout the voyage.",
    featured: true,
  },
  {
    id: 2,
    ...
    salary: "$2,900 - $3,800 monthly",
    description: "Support world-class onboard shows by operating and maintaining stage lighting, sound systems, and entertainment technology..",
    featured: true,
  },
  {
    id: 3,
    ...
    department: "Food & Beverage",
    location: "Alaska Routes",
    salary: "$3,300 - $4,600 monthly",
    description: "Work alongside our restaurant leadership team to deliver outstanding dining service while ensuring smooth daily operations on board.",
    featured: true,
  },
]
...
const upcomingCruises = [
  {
    id: 1,
    title: "Alaska Glacier & Fjords Cruise",
    duration: "9 nights",
    departure: "Seattle, WA",
    destinations: "Glacier Bay, Ketchikan, Icy Strait Point, Juneau, Sitka",
    price: "From $1,299",
  ...
  },
  {
    ...
    destinations: "Ibiza, Rome (Civitavecchia), Naples, Cannes, Florence/Pisa",
    price: "From $1,899",
    date: "May 8, 2026",
    cruiseLine: "Norwegian Cruise Line",
  ...
  {
    id: 3,
    title: "Caribbean Island‑Hopping Adventure",
    duration: "8 nights",
...
const testimonials = [
  {
    id: 1,
    name: "Isabella Chen",
    position: "Cruise Director, 6 years with Norwegian Cruise Line",
    quote:
      "Every day onboard is a new adventure. Norwegian Cruise Line gave me the chance to lead a talented entertainment team while traveling to breathtaking destinations. I truly feel part of a family here.",
    avatar: "/placeholder.svg?height=80&width=80",
  },
  {
    id: 2,
    name: "Liam Garcia",
    position: "Sous Chef, 4 years with Norwegian Cruise Line",
    quote:
      "The support from the recruitment team was incredible. I found a role that challenged me creatively and let me showcase my culinary skills while exploring amazing ports around the world.",
    avatar: "/placeholder.svg?height=80&width=80",
  },
  {
    id: 3,
    name: "Amara Johnson",
    position: "Senior Deck Officer, 5 years with Norwegian Cruise Line",
    quote:
      "Working at sea has always been my dream, and Norwegian Cruise Line made it a reality. The training and career growth opportunities are unmatched in the industry.",
    avatar: "/placeholder.svg?height=80&width=80",
  },
]
