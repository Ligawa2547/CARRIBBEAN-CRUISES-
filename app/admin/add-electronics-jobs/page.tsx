import { addElectronicsJobs } from "@/app/actions/add-electronics-jobs"
import { Button } from "@/components/ui/button"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import Link from "next/link"

export default async function AddElectronicsJobsPage() {
  // Execute the action to add electronics jobs
  const result = await addElectronicsJobs()
    ...
    <div className="container py-10 md:py-16 px-4 md:px-6">
      <div className="mx-auto max-w-3xl">
        <Card className="border-0 shadow-md bg-white dark:bg-slate-800">
          <CardHeader>
            <CardTitle className="text-ocean-950 dark:text-white">Add Electronics Department Jobs</CardTitle>
            <CardDescription>
              Adding 29 specialized electronics jobs to the cruise ship recruitment database
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div
            ...
            >
              ...
              {result.success && result.added !== undefined && (
                <p className="mt-2">
                  {result.added > 0
                    ? `Added ${result.added} new electronics jobs to the database.`
...
created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
            ...
            {result.success && (
              <div className="space-y-4">
                <h3 className="font-medium text-ocean-950 dark:text-white">Electronics Jobs Added:</h3>
                <p className="text-slate-600 dark:text-slate-300">
                  Added 29 specialized electronics positions including:
                </p>
                <ul className="list-disc pl-5 space-y-2 text-slate-600 dark:text-slate-300">
                  <li>Chief Electronics Officer</li>
                  <li>Navigation Electronics Specialist</li>
                  <li>Communication Systems Technician</li>
                  <li>Entertainment Systems Technician</li>
                  <li>Security Systems Technician</li>
                  <li>Medical Equipment Technician</li>
                  <li>Automation Systems Specialist</li>
                  <li>Power Electronics Specialist</li>
                  <li>Radar Technician</li>
                  <li>And many more specialized roles...</li>
                </ul>
              </div>
            )}
            ...
            <div className="mt-6 flex gap-3">
              ...
              {!result.success && (
                <Button asChild variant="outline">
                  <Link href="/admin/add-electronics-jobs">Try Again</Link>
                </Button>
              )}
            </div>
          </CardContent>
